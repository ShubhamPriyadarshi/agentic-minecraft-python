...
# Detect macOS ARM for software renderer fallback
IS_MACOS_ARM = (platform.system() == "Darwin" and platform.machine() == "arm64")

if IS_MACOS_ARM:
    from src.rendering.software_renderer import SoftwareRenderer as Renderer
...
class OpenGLRenderer:
    ...
    def clear(self):
        gl.glClearColor(0.53, 0.61, 0.73, 1.0)
...
# Export the appropriate renderer class
if IS_MACOS_ARM:
    # On macOS ARM, the SoftwareRenderer IS the Renderer class
    pass
else:
